...
from app.embedding.domain.events import EmbeddingRequestedEvent
from app.embedding.ports.chunk_repository import CURRENT_EMBEDDING_VERSION, IChunkRepository
